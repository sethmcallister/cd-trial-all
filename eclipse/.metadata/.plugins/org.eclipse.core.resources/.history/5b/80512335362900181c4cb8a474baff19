...
public class ExerciseGUI extends Gui {
	...
	private static final ResourceLocation resourceLocation = new ResourceLocation("CD", "exercise_bar.png");
	...
	public void onRenderGameOverlay(final RenderGameOverlayEvent event) {
		...
		if (exerciseLevel < player.getMaxExerciseLevel()) {
			entityPlayer.canEat(true);
		}
